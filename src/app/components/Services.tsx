...
const Services = () => {
  ...
  return (
    <section className="relative py-16 md:py-24 bg-gradient-to-b from-gray-50 to-white font-sans overflow-hidden">
        ...
        >
          {services.map((service, index) => (
            <motion.div
              ...
              className={`group relative ${service.bgColor} p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 overflow-hidden`}
            >
              ...
              <div
                className={`relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 mb-4 md:mb-6 rounded-xl bg-gradient-to-r ${service.gradient} text-white shadow-lg`}
              >
                {service.icon}
              </div>
              <h3 className="relative text-lg md:text-xl lg:text-2xl font-semibold mb-3 md:mb-4 text-gray-800 font-montserrat group-hover:text-gray-900 transition-colors">
                {service.title}
              </h3>
              ...
              <Link
                href="/services"
                className="relative inline-flex items-center text-gray-900 font-medium group-hover:text-blue-600 transition-colors font-open-sans mt-4 md:mt-6"
              >
                Learn More
